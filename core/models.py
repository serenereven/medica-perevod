...
class Document(TimeStampedModel, PublishableModel):
    ...
    preview = models.ImageField(upload_to="documents/preview/", blank=True, null=True, verbose_name="Превью")
    document_type = models.CharField(
        max_length=20, choices=DocumentType.choices, default=DocumentType.OTHER, verbose_name="Тип документа"
    )
    ...
    file_size = models.PositiveIntegerField(blank=True, null=True, editable=False, verbose_name="Размер файла (байты)")
    ...
    class Meta:
        ...
        ordering = ["-created_at"]
        constraints = [models.UniqueConstraint(fields=["file"], name="unique_document_file")]
